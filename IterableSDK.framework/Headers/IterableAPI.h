...
/*!
 ...
 @return an instance of IterableAPI
 */
- (instancetype) initWithApiKey:(NSString *)apiKey launchOptions:(nullable NSDictionary *)launchOptions andUserId:(NSString *)userId;
...
/*!
 ...
 @return an instance of IterableAPI
 */
- (instancetype) initWithApiKey:(NSString *)apiKey launchOptions:(nullable NSDictionary *)launchOptions  andUserId:(NSString *)userId useCustomLaunchOptions:(BOOL)useCustomLaunchOptions;
...
/*!
 ...
 @return an instance of IterableAPI
 */
+ (IterableAPI *) sharedInstanceWithApiKey:(NSString *)apiKey launchOptions:(nullable NSDictionary *)launchOptions andUserId:(NSString *)userId;
